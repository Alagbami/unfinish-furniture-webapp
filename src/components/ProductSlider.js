              ...
              {page.productList.map((product, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    w-full max-w-[285px] h-full max-h-[292px] 
                    flex items-center justify-center mb-[15px]
                    relative transitions'>
                      <img src={image.type} alt={name} />
                      <div className='absolute bottom-4 right-[22px]
                      bg-gray-200 w-8 h-8 rounded-full
            ...
            {page.productList.map((product, productIndex) => {
              ...
              return (
                <div
                  ...
                  key={productIndex}
                >
                  <div className='border hover:border-accent rounded-[18px] w-full max-w-[285px] h-full max-h-[292px] flex items-center justify-center mb-[15px] relative transitions'>
                    <img src={image.type} alt={name} />
